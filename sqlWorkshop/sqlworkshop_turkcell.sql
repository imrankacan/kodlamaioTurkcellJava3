...
select product_id,CONCAT('TR ', upper(product_name)) as ürün_adı,unit_price from products where unit_price<20 order by unit_price
...
select e.first_name, count(*) as toplam_siparis
from employees e
...
select company_name,contact_name,address,country,city from customers where country like 'Brazil'


    69. Brezilya’da olmayan müşteriler

select company_name,contact_name,address,country,city from customers where country not like 'Brazil'
